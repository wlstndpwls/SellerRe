...
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/assets/css/inc/topbar(css).css">


<script src="https://code.jquery.com/jquery-1.11.3.js"></script>
<script
	src="${pageContext.request.contextPath }/assets/js/product_priceReplace.js"></script>


<title>WishList</title>
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/assets/css/wish/wishList(css).css">
</head>
<body>
			...
			<div class="wish_product_container">
				<div class="product_img_area">
					<a class="prod_detail_link"	href="${pageContext.request.contextPath }/product/productDetail?user_id=${sessionScope.user_id }&product_num=${i.product_num}">
						...
						src="${pageContext.request.contextPath }/productImg?fname=${fileList[status.index]}&product_num=${i.product_num}" />
					</a>
				</div>
				<!-- 상품 정보 영역-->
				<div class="product_info_area">
					...
					<div class="wish_product_info_container">
						<dlv class="wish_product_info">
							<a class="wish_product_list" href="${pageContext.request.contextPath }/product/productDetail?user_id=${sessionScope.user_id }&product_num=${i.product_num}">
							${i.product_info } </a> </dlv>
					</div>
					<!--상품 카테고리 영역 -->
					<div class="wish_product_category_container">
						<div class="wish_product_category">
							<a class="wish_product_list" href="${pageContext.request.contextPath }/product/searchCategoryName?user_id=${sessionScope.user_id }&categoryName=${c1[status.index].category_name}">
								<div class="prod_category">${ c1[status.index].category_name }
									> ${ c2[status.index].category_name } > ${ c3[status.index].category_name }
								</div>
							</a>
						</div>
					</div>
					...
					<div class="wish_product_reply_container">
						<div class="wish_product_reply_area">
							...
							<div class="wish_product_reply_img">
								<a class="wish_product_list" href="${pageContext.request.contextPath }/product/productDetail?user_id=${sessionScope.user_id }&product_num=${i.product_num}">
								<img src="${pageContext.request.contextPath }/assets/img/bubble.png" />
								</a>
							</div>
						</div>
						<!-- 댓글 갯수 영역 -->
